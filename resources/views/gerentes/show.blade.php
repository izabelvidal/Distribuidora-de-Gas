...
<div class="form-group">
    ...
    <div class="form-row">
        ...
        <div class="col-md-4">
            ...
            <input class="form-control" type="date" name="nascimento" id="nascimento" value="{{ $gerente->pessoa->nascimento }}" readonly>
        </div>
    </div>
    <div class="form-row">
        <div class="col-md-4">
            <label for="cidade">Cidade</label>
            <input class="form-control" type="text" name="cidade" id="cidade" value="{{ $gerente->pessoa->endereco->cidade }}" readonly>
        </div>
        <div class="col-md-4">
            <label for="bairro">Bairro</label>
            <input class="form-control" type="text" name="bairro" id="bairro" value="{{ $gerente->pessoa->endereco->bairro }}" readonly>
        </div>
        <div class="col-md-4">
